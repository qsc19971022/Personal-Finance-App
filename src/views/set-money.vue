 ...
 * @LastEditTime: 2020-03-09 13:58:27
...
import header from '../components/setMoney/header'
import body from '../components/setMoney/body'
import footer from '../components/setMoney/footer'
export default {
