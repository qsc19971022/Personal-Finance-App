 ...
 * @LastEditTime: 2020-03-09 14:34:50
...
import header from '../components/getMoney/header'
import body from '../components/getMoney/body'
import footer from '../components/getMoney/footer'
export default {
